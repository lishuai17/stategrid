...
public class DeclareController {
	...
	public String addDeclare(String classCode, Model model, HttpServletRequest request,
	...
	public String deleteDeclare(String classCode, Model model, HttpServletRequest request,
			HttpServletResponse response) {
		return "";
	}
